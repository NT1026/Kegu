...
video = cv2.VideoCapture('https://cctvn.freeway.gov.tw/abs2mjpg/bmjpg?camera=10002&0.7547919814792337')
WIDTH = 1280
HEIGHT = 720
...
def trackMultipleObjects():
    ...
    while True:
        ...
        if carTracker == {}:
            ...
            for i in carTracker.keys():
                if speed[i] == None:
                    #print('there is a car has no speed')
                    board.digital[pin].write(0)
                    continue
                else:
